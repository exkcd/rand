...
public class ConversionGUI {
    ...
    // ToDo:   Add "Mass" and "Volume" to following "Array"
    ...
    String[] volumeTypesArray1 = {"Cup", "Gallon", "Liter", "Milliliter", "Pint", "Quart"};
    String[] volumeTypesArray2 = {"Gallon", "Liter", "Milliliter", "Pint", "Quart", "Cup"};

    String[] massTypesArray1 = {"Gram", "Kilogram", "MetricTon", "Milligram", "Ounce", "Pound", "Ton"};
    String[] massTypesArray2 = {"Kilogram", "MetricTon", "Milligram", "Ounce", "Pound", "Ton", "Gram"};

    String[] areaTypesArray1 = {"Acre", "Hectare", "SquareFoot", "SquareInch", "SquareKilometer", "SquareMeter", "SquareMile", "SquareYard"};
    String[] areaTypesArray2 = {"Hectare", "SquareFoot", "SquareInch", "SquareKilometer", "SquareMeter", "SquareMile", "SquareYard", "Acre"};

    String[] temperatureTypesArray1 = {"Celsius", "Fahrenheit", "Kelvin"};
    String[] temperatureTypesArray2 = {"Fahrenheit", "Celsius", "Kelvin"};
    ...
    public ConversionGUI() {
        ...
        // ToDO:  Mass  spinner
        // Add your code here for massTypesModels - use same pattern as area/temp/length models below.
        CyclingSpinnerListModel massTypesModel1 = new CyclingSpinnerListModel(massTypesArray1);
        CyclingSpinnerListModel massTypesModel2 = new CyclingSpinnerListModel(massTypesArray2);

        // ToDO: Volume Types spinner
        // Add your code here for volumeTypesModels
        CyclingSpinnerListModel volumeTypesModel1 = new CyclingSpinnerListModel(volumeTypesArray1);
        CyclingSpinnerListModel volumeTypesModel2 = new CyclingSpinnerListModel(volumeTypesArray2);

        CyclingSpinnerListModel areaTypesModel1 = new CyclingSpinnerListModel(areaTypesArray1);
        CyclingSpinnerListModel areaTypesModel2 = new CyclingSpinnerListModel(areaTypesArray2);

        CyclingSpinnerListModel tempTypesModel1 = new CyclingSpinnerListModel(temperatureTypesArray1);
        CyclingSpinnerListModel tempTypesModel2 = new CyclingSpinnerListModel(temperatureTypesArray2);

        CyclingSpinnerListModel lengthTypesModel1 = new CyclingSpinnerListModel(lengthTypesArray);
        CyclingSpinnerListModel lengthTypesModel2 = new CyclingSpinnerListModel(lengthTypesArray2);
        ...
        conversionSelectionA.setModel(lengthTypesModel1);
        conversionSelectionB.setModel(lengthTypesModel2);
        ...
        conversionTypeSpinner.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent e) {
                if (conversionTypeSpinner.getValue().equals("Length")) {
                    ...
                    conversionSelectionA.setModel(areaTypesModel1);
        ...
        conversionSelectionA.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent e) {
        ...
        conversionSelectionB.addChangeListener(new ChangeListener() {
            @Override
            public void stateChanged(ChangeEvent e) {
                String text = textField1.getText();
                double num = 0.0;
                if (!text.equals("")) num = Double.parseDouble(textField1.getText());
                try {
        ...
        textField2.addKeyListener(new KeyAdapter() {
            public void keyReleased(KeyEvent ke) {
                if (!(ke.getKeyChar() == 27 || ke.getKeyChar() == 65535))//this section will execute only when user is editing the JTextField
                {
                    ...
                    double num = 0.0;
                    try {
                        if (!text.equals("")) num = Double.parseDouble(textField2.getText());
    ...
    public void showErrorMessage(String message) {
        JOptionPane.showMessageDialog(mainFrame, message, "Unit Conversion Tool Error", JOptionPane.ERROR_MESSAGE);
    }
